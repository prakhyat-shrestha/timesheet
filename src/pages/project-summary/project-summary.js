...
*/
var ProjectSummaryPage = (function () {
    function ProjectSummaryPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    ProjectSummaryPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ProjectSummaryPage');
    };
    return ProjectSummaryPage;
}());
ProjectSummaryPage = __decorate([
    Component({
